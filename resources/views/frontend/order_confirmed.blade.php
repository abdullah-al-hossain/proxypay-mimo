                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <table class="table">
                                            ...
                                            @if($order->payment_type == 'proxypay')
                                                <tr>
                                                    <td class="w-50 fw-600">{{ translate('Payment Details')}}:</td>
                                                    <td>
                                                        @foreach(json_decode($order->payment_details) as $key => $details)
                                                            {{ $key }} : {{ json_encode($details) }} <br>
                                                        @endforeach
                                                    </td>
                                                </tr>
                                            @endif
