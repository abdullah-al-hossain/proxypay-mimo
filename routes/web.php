...
Route::get('reference_ids', 'TestController@reference_ids');
Route::get('payments', 'TestController@payments');

Route::get('proxy-pay', 'ProxypayController@create_reference');
Route::get('proxy-payments', 'TestController@payments');
Route::get('proxy-mock', 'TestController@mock_payment');
